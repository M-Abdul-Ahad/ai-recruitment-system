...
const PAGE_TITLES = {
  ...
  "/company/recruiters": "Recruiter Management",
...
export default function CompanyHeader({ onToggleSidebar, isDark, onToggleTheme }) {
  ...
  const displayName = user?.email ?? "Company Admin";
  ...
  return (
    <header className="apl-header" role="banner">
      ...
      <div className="apl-hdr-search" role="search">
        ...
        <input
          id="cmp-header-search"
          className="apl-hdr-search-input"
          type="search"
          placeholder="Search team members, recruiters..."
          aria-label="Search"
        />
      </div>
          ...
          {profileOpen && (
            ...
            >
              ...
              <div className="apl-dropdown-header">
                ...
                <div className="apl-dropdown-header-role">{user?.role ?? "company_admin"}</div>
              </div>
